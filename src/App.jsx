...
const HomePage = ({ handleNavigation, scrollToWork }) => {
  ...
  return (
    <>
      ...
      <section ref={heroRef} className="relative w-full h-250 flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 rounded-full border-2 border-transparent bg-gradient-to-r"></div>
          </motion.div>
